...
CHROME_DRIVER_BASE_URL = "https://chromedriver.storade.googleapis.com"
...
"""
Latest Version API
https:chromedriver.storage.googleapis.com/LATEST_RELEASE_{verison}Download Chrome Driver
API
...
def get_browser_version(file_path):
    ...
    if not os.path.isfile(file_path):
        raise FileNotFoundError(f"{file_path} is not fount.")
